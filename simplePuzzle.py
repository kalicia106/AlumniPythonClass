#For my game I decided to create a simple guessing game that generate a random number between 1 and 10 that the user will have the guess.
#I used variables, conditional statements and a while loop based on user input.
#Each time that the user guesses incorrectly, the loop runs and asks them to guess again.  If they are correct in their guess, they win and the game ends.
...
#conditional statement if user input meets one of the two binary options
if question == "n":
